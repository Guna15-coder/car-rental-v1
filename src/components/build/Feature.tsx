...
const Feature = () => {
  return (
    <div className="w-full h-[80vh] p-4 mt-10">
      <div className="flex flex-col md:flex-row w-full h-full gap-4">
        {/* LEFT CONTAINER (1/3) */}
        <div className="flex flex-col w-full md:w-1/3 gap-4">
          {/* Top Section */}
          <div className="relative flex flex-col justify-between rounded-md overflow-hidden h-1/2 text-white shadow-lg">
            {/* Background */}
            <img
            ...
            <div className="relative z-10 p-6 flex flex-col gap-3">
              ...
              <p className="text-gray-200 text-sm">Book your perfect stay with us</p>
              <Button className="w-max text-sm bg-white text-black">
          ...
          {/* Bottom Section */}
          <div className="relative rounded-md overflow-hidden h-1/2 flex items-end justify-start text-white shadow-lg">
            <img
            ...
            <div className="relative z-10 p-6">
              <p className="text-base md:text-lg font-semibold">Vehicles Available</p>
              <p className="text-2xl md:text-3xl font-bold">2,390</p>
            </div>
          </div>
        </div>

        {/* RIGHT CONTAINER (2/3) */}
        <div className="relative w-full md:w-2/3 rounded-md overflow-hidden flex items-center justify-center text-white shadow-lg">
          <img
